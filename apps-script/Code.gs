...
var DICIONARIO_LINHAS = [
  ...
  ['faltas / atraso', 'calculado', 'painel', 'Com o ponto lançado: atraso = atrasosPonto; faltas = naoTrabalhadas − horasFerias − atraso (tudo que não foi trabalhado, tirando férias — a conta que era feita na mão). Sem ponto: o digitado.'],
